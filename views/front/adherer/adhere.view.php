            ...
            <div class="card-body">
              <div class="container">
                ...
                <section class="section">
                  <!--Section heading-->
                  <h2 class="font-weight-bold text-center h1  perso_textBleuLire">ADHERER AU MOUVEMENT</h2>
                  <!--Section description-->
                  <p class="text-center mb-5 mx-auto w-responsive">Pour bâtir une Cote d'Ivoire sécurisée et reconciliée, en paix et au travail.</p>
                  <div class="row">
                    <!--Grid column-->
                  ...
                  <div class="card">
                    <div class="card-body">
                      <form>
                        ...
                        <form method="POST" action="#" class="p-1">
                            ...
                            <div class="form-group md-form row no-gutters align-items-center">
                                <input type="number" name="age" id="age" class="form-control col" Placeholder = "Votre age" required/>
                            </div>
                            <div class="form-group md-form row no-gutters align-items-center">
                            ...
                            <div class="form-group md-form row no-gutters align-items-center">
                              ...
                              <input type="submit" class="btn btn-orange mx-auto d-block" value="Valider" />
                              </div>
                        </form>
                        <?php 
                            ...
                            isset($_POST['captcha']) && !empty($_POST['captcha'])
                                ...
                                if($captcha === 8){
                                    ...
                                    mail($destinataire, $objet. "Adhesion de: " . $nom, "Nom : ". $nom. " Prenom : " . $prenom. " sexe : " . $sexe. " mail : " . $mail. " age : " . $age. " nationalite : " . $nationalite. " residence : " . $residence);
                    ...
                    <div class="card">
                      ...
                      <strong><p> Vous souhaitez adhérer ou représenter le mouvement dans votre région au
                           plan national ou dans la diaspora inscrivez-vous ici et vous serez contacté.</p></strong>
                        <li>
                        ...
                        <li>
                          ...
                          <p>adherer@lalternativeci.org</p>
                        </li>
                      </ul>
                      </div>
                    </div>
